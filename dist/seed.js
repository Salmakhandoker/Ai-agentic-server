...
const MONGO_URI = environment_1.config.mongoUri;
if (!MONGO_URI) {
...
const seedData = async () => {
    try {
        ...
        await models_1.Listing.insertMany(listings);
